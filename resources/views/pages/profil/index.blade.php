    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <h2 class="section-title">Hi, Idris!</h2>
                    ...
                    <div class="col-12 col-md-12 col-lg-5">
                        <div class="card profile-widget">
                            ...
                            <div class="profile-widget-description">
                                <div class="profile-widget-name">IDRIS HALUSI<div
                                        class="text-muted d-inline font-weight-normal">
                                        <div class="slash"></div> Web Developer
                                    </div>
                                </div>
                                Idris Halusi<b>Indonesia</b>, Mahasiswa POlitekni Gorontalo, Prodi Teknik Informatika, Semester 5

                            </div>
                            <div class="card-footer text-center">
                                <div class="font-weight-bold mb-2">Follow Idris On</div>
                                <a href="#"
